...
def create_sound(frequency, volume):
    ...
    for i in range(num_samples):
        ...
        if i < sample_rate * 0.01: # 1% of the sound duration for fade-in
            sound_sample *= i / (sample_rate * 0.01)
        elif i > num_samples - sample_rate * 0.02: # 1% of the sound duration for fade-out
            sound_sample *= (num_samples - i) / (sample_rate * 0.01)
        sound_data.append(sound_sample * 32767)
